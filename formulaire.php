...
inscrivez-vous cher adminstrateur
           ...
           <legend for="">nom</legend>
            ...
            <input type="email" name="email" class="col-6 offset-3> <br> <br>
            <legend for="">pass</legend>
            <input type="password" name="pass" class="col-6 offset-3> <br> <br>
            <legend for="">cpass</legend>
            <input type="password" name="cpass" class="col-6 offset-3> <br> <br>
